...
export function Services() {
  ...
  return (
    <section id="servicos" className="p-interface py-8 bg-light-10%">
      ...
      <div className="mt-4 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
        {servicesList.map((item) => {
          return (
            <div
              key={item.title}
              className="flex flex-col items-center gap-4 text-center p-4 bg-light rounded group transition-colors duration-500 hover:bg-black"
            >
              <div
                className="bg-mainColor rounded-full text-4xl p-3
              "
              >
                {item.icon}
              </div>
              <h3 className="font-bold text-xl transition-colors duration-500 group-hover:text-white">
                {item.title}
              </h3>
              <p className="opacity-70 transition-colors duration-500 group-hover:text-white">
                Lorem Ipsum Dolor Sit Amet Consettetur Adipiscing Elit.
                Corporis, Nisi.
              </p>
              <button className={buttonCss} aria-labelledby="Leia mais">
                Leia mais
              </button>
            </div>
          );
